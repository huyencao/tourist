<div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
    <ul class="list-group panel">
        ...
        <li class="list-group-item"><a href="{{ route('menu.index') }}"><i class="glyphicon glyphicon-th-list"></i> {{ __('Menu') }} </a>
        </li>
        ...
        <li class="list-group-item"><a href="{{ route('news.index') }}"><i class="fa fa-list"></i> {{ __('News') }} </a>
